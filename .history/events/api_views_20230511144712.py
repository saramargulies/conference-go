...
import json
from .acls import get_pexels, get_weather_data
...
def api_list_conferences(request):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return JsonResponse({"message": "Invalid location id"}, status=404)
...
def api_show_conference(request, id):
    ...
    if request.method == "GET":
        ...
        return JsonResponse(
            conference_data, encoder=ConferenceDetailEncoder, safe=False
        )
...
def api_list_locations(request):
    ...
    if request.method == "GET":
        ...
        photo = get_pexels(content["city"], content["state"].abbreviation)
