...
def process_approval(ch, method, properties, body):
    ...
    send_mail(
        ...
        f"{jbody.presenter_name}, we're happy to tell you that your presentation {body.title} has been accepted"
        "admin@conference.go",
...
def process_rejection(ch, method, properties, body):
    ...
    send_mail(
        ...
        f"{body.presenter_name}, we regret to tell you that your presentation {body.title} has been rejected"
        "admin@conference.go",
        [body.presenter_email],
        fail_silently=False,
    )
